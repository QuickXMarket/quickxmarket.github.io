  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-background">
      <form
        ...
        className="flex flex-col gap-5 w-full max-w-sm p-6 rounded-2xl shadow-md border border-gray-200 bg-card transition-all"
      >
        {/* Profile Upload */}
        <label
        ...
        <div className="w-full relative">
          ...
          {suggestions.length > 0 && (
            <ul className="absolute z-50 bg-card border border-gray-300 rounded w-full max-h-40 overflow-auto mt-1 shadow-md">
